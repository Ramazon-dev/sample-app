...
class Constants {
  ...
  static const baseUrl = 'https://test.api.client.macbro.uz/v1/';
  static const authUrl = 'https://test.api.auth.macbro.uz/v1/';
  ...
  static const phoneSlug = "iphone-11-24fxsvnpkmsvpeb0";
